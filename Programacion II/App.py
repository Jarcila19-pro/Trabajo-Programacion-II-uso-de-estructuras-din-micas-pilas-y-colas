...
/* ── TEXTO OSCURO EN AREA PRINCIPAL ── */
.block-container p,
...
/* ── BANNER SIGUIENTE ── */
.banner-siguiente p { color: white !important; }
...
.tabla-precios th:first-child { text-align:left; }
.tabla-precios td {
    padding: 0.7rem 1rem;
    font-size: 0.88rem;
...
.tabla-precios td:first-child { text-align:left; font-weight:600; color:#0a2342 !important; }
.tabla-precios tr:last-child td { border-bottom: none; }
.tabla-precios tr:hover td { background:#f7faff; }
.precio-base { color:#6b7c9a !important; font-size:0.78rem; font-weight:400; }
.precio-chip-particular { background:#fefcbf; color:#744210 !important; padding:0.15rem 0.6rem; border-radius:20px; font-weight:600; font-size:0.82rem; }
.precio-chip-eps        { background:#c6f6d5; color:#276749 !important; padding:0.15rem 0.6rem; border-radius:20px; font-weight:600; font-size:0.82rem; }
.precio-chip-prepagada  { background:#e9d8fd; color:#553c9a !important; padding:0.15rem 0.6rem; border-radius:20px; font-weight:600; font-size:0.82rem; }
.precio-gratis { color:#38a169 !important; font-weight:600; font-size:0.88rem; }
.nota-precio { background:#ebf4ff; border-left:4px solid #1a6bd4; border-radius:8px; padding:0.8rem 1rem; font-size:0.83rem; color:#1a2a3a !important; margin-top:0.5rem; }
</style>
...
# ── TARIFAS ──────────────────────────────────────────────────
    ...
    st.markdown('<p class="section-header">Tabla de tarifas</p>', unsafe_allow_html=True)
    st.markdown('<p class="section-sub">Precios por tipo de cliente y tipo de atención · Calzas y Extracción se multiplican por cantidad</p>', unsafe_allow_html=True)
    st.markdown('<div class="deco-line"></div>', unsafe_allow_html=True)
    ...
    <table class="tabla-precios">
        ...
        <tbody>
            <tr>
                <td>💳 Cita base</td>
                <td><span class="precio-chip-particular">$80.000</span></td>
                <td><span class="precio-chip-eps">$5.000</span></td>
                <td><span class="precio-chip-prepagada">$30.000</span></td>
            </tr>
            <tr>
                <td>🦷 Limpieza</td>
                <td><span class="precio-chip-particular">+$60.000</span></td>
                <td><span class="precio-gratis">Incluida</span></td>
                <td><span class="precio-gratis">Incluida</span></td>
            </tr>
            <tr>
                <td>🦷 Calzas <span class="precio-base">(por unidad)</span></td>
                <td><span class="precio-chip-particular">+$80.000 c/u</span></td>
                <td><span class="precio-chip-eps">+$40.000 c/u</span></td>
                <td><span class="precio-chip-prepagada">+$10.000 c/u</span></td>
            </tr>
            <tr>
                <td>🦷 Extracción <span class="precio-base">(por unidad)</span></td>
                <td><span class="precio-chip-particular">+$100.000 c/u</span></td>
                <td><span class="precio-chip-eps">+$40.000 c/u</span></td>
                <td><span class="precio-chip-prepagada">+$10.000 c/u</span></td>
            </tr>
            <tr>
                <td>🦷 Diagnóstico</td>
                <td><span class="precio-chip-particular">+$50.000</span></td>
                <td><span class="precio-gratis">Incluido</span></td>
                <td><span class="precio-gratis">Incluido</span></td>
            </tr>
        </tbody>
    </table>
    <p class="nota-precio">
        💡 <strong>Fórmula:</strong> Total = Cita base + (Precio atención × Cantidad) &nbsp;·&nbsp;
        Limpieza y Diagnóstico tienen cantidad fija de 1 &nbsp;·&nbsp;
        Calzas y Extracción se multiplican por la cantidad ingresada.
    </p>
    """, unsafe_allow_html=True)

    st.markdown('<div class="deco-line"></div>', unsafe_allow_html=True)
    st.markdown("### Ejemplos de cobro")

    col1, col2, col3 = st.columns(3)
    with col1:
        st.markdown('<div class="metric-card"><h3>$140.000</h3><p>Particular · Limpieza</p></div>', unsafe_allow_html=True)
        st.markdown('<div class="metric-card"><h3>$260.000</h3><p>Particular · 2 Calzas</p></div>', unsafe_allow_html=True)
    with col2:
        st.markdown('<div class="metric-card"><h3>$85.000</h3><p>EPS · 2 Calzas</p></div>', unsafe_allow_html=True)
        st.markdown('<div class="metric-card"><h3>$45.000</h3><p>EPS · Extracción</p></div>', unsafe_allow_html=True)
    with col3:
        st.markdown('<div class="metric-card"><h3>$60.000</h3><p>Prepagada · 3 Extracciones</p></div>', unsafe_allow_html=True)
        st.markdown('<div class="metric-card"><h3>$30.000</h3><p>Prepagada · Limpieza</p></div>', unsafe_allow_html=True)
